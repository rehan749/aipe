...
import PopularNews from '@/components/CategoryNews/PopularNews'
  ...
  return (
    ...
    <PopularNews/>
                ...
                <div className="mb-3 pb-3">
                    <a href=""><img className="img-fluid w-100" src="img/ads-700x70.jpg" alt="" /></a>
                </div>
      ...
      <img className="img-fluid w-100" src="img/news-500x280-5.jpg" alt="Overlay" style={{ objectFit: 'cover' }} />
      <div className="overlay position-relative bg-light">
        ...
        <p className="m-0">Rebum dolore duo et vero ipsum clita, est ea sed duo diam ipsum, clita at justo, lorem amet vero eos sed sit...</p>
                        ...
                        <img src="img/news-100x100-5.jpg" alt="News Image" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
                        ...
                        <div className="d-flex mb-3">
      <img src='' alt="News Image" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
      <div className="w-100 d-flex flex-column justify-content-center bg-light px-3" style={{ height: '100px' }}>
        ...
        <a className="h6 m-0" href="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, rerum.a</a>
      </div>
    </div>
                    </div>
                    {/* <div className="col-lg-6">
                        <div className="position-relative mb-3">
                            <img className="img-fluid w-100" src="img/news-500x280-6.jpg" style="object-fit: cover;" />
                            <div className="overlay position-relative bg-light">
                                <div className="mb-2" style="font-size: 14px;">
                                    <a href="">Technology</a>
                                    <span className="px-1">/</span>
                                    <span>January 01, 2045</span>
                                </div>
